...
// ============================================
// BUSINESS.YELLOW.COM DOMAIN (Business Portal)
// ============================================
Route::domain(config('app.business_domain'))->group(function () {
    
    // Business Landing Page
    Route::get('/', function () {
        return view('business.home'); // Create this view for business landing
    })->name('business.home');

    // Guest Business Creation
    Route::get('/list-your-business', CreateGuestBusiness::class)
        ->name('guest.business.create');
    
    // Additional business domain pages (optional)
    // Route::get('/why-list', ...)->name('business.why-list');
    // Route::get('/pricing', ...)->name('business.pricing');
    // Route::get('/success-stories', ...)->name('business.success-stories');
});

// ============================================
// MAIN YELLOW.COM DOMAIN (Customer Site)
// ============================================
...
// Webhooks, manager invitations, unsubscribes
// ============================================
...
// Manager Invitation Routes (Public - can be accessed from any domain)
