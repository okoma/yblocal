...
class ViewQuoteRequest extends ViewRecord
{
    ...
    public function infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ->schema([
                Infolists\Components\Tabs::make('QuoteRequestTabs')
                    ->tabs([
                        Infolists\Components\Tabs\Tab::make('Request Quote')
                            ->icon('heroicon-o-document-text')
                            ->schema([
                        ...
                        Infolists\Components\Tabs\Tab::make('Shortlisted')
                            ->icon('heroicon-o-star')
                            ->badge(fn ($record) => $record->responses()->where('status', 'shortlisted')->count())
                            ->schema([
                        ...
                        Infolists\Components\Tabs\Tab::make('Price Compare')
                            ->icon('heroicon-o-chart-bar')
                            ->schema([
                                Infolists\Components\Section::make('Price Comparison')
                                    ->description('Compare shortlisted quotes side by side')
                                    ->schema([
