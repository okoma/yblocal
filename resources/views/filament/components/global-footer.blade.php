...
<div class="mt-auto">
  <footer class="py-4 px-5 flex flex-col md:flex-row items-center justify-between text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700">
    <!-- Left Side -->
